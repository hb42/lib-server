...
class MongoDB {
    constructor(srv, db, port, opts) {
        ...
        opts = Object.assign({}, opts, { poolSize: 200, reconnectTries: 100, reconnectInterval: 1000, autoReconnect: true, keepAlive: 0, connectTimeoutMS: 0, socketTimeoutMS: 0, useNewUrlParser: true });
